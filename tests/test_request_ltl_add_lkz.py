...
def test_ltl_request_no_publish_add_lkz(domain):
    ...
    cpl.click_button_index(cpl.cp_list_checkbox, 2)
...
def test_ltl_request_rate_add_lkz(domain):
    ...
    ltl.click_and_input_in_field(ltl.rate_input,  base.random_value_int_str(1000, 100000))
    ltl.click_button(ltl.publish_button, do_assert=True)
    ltl.click_button(ltl.ok_button, do_assert=True, wait="lst")
