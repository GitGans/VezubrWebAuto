...
def test_transport_edit_lkp(domain):
    ...
    add_ts.dropdown_click_input_click(add_ts.owner_types_select, "Безвозмездное пользование")
    ...
    add_ts.backspace_all_and_input(add_ts.height_from_ground_input, "1")
...
def test_semitrailer1_edit_lkp(domain):
    ...
    add_ts.dropdown_click_input_click(add_ts.year_select, "2023")
    add_ts.dropdown_click_input_click(add_ts.vehicle_categories_select, "Грузовая")
    add_ts.dropdown_click_input_click(add_ts.vehicle_body_types_select, "Бортовой")
    ...
    add_ts.click_button(add_ts.edit_button)
    add_ts.dropdown_click_input_click(add_ts.owner_types_select, "Совместная собственность супругов")
    add_ts.dropdown_click_input_click(add_ts.year_select, "2020")
    add_ts.dropdown_click_input_click(add_ts.vehicle_categories_select, "Трал")
    add_ts.click_button(add_ts.sanitation_toggl)
    add_ts.click_button(add_ts.sanitary_date_button)
    add_ts.input_in_field(add_ts.calendar_input, "10102045")
    add_ts.backspace_all_and_input(add_ts.capacity_input, "80")
    add_ts.backspace_all_and_input(add_ts.height_from_ground_input, "5")
...
def test_semitrailer2_edit_lkp(domain):
    ...
    add_ts.click_button(add_ts.sanitary_date_button)
    add_ts.input_in_field(add_ts.calendar_input, "10102045")
    add_ts.dropdown_click_input_click(add_ts.vehicle_categories_select, "Самосвал")
    ...
    add_ts.dropdown_click_input_click(add_ts.year_select, "2024")
    add_ts.click_button(add_ts.sanitation_toggl)
    add_ts.dropdown_click_input_click(add_ts.vehicle_categories_select, "Контейнеровоз")
    add_ts.backspace_all_and_input(add_ts.capacity_input, "25")
    add_ts.backspace_all_and_input(add_ts.height_from_ground_input, "1")
    add_ts.input_in_field(add_ts.platform_height_input, "1.5")
