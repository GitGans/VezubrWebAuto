...
def test_cargo_place_own_add_lke(domain):
    ...
    cp_list.move_find_and_click(move_to=cp_list.date_hover, click_to=cp_list.date_clear_button, wait="lst")
    cp_list.click_button(cp_list.cp_list_checkbox_2)
    cp_list.click_button(cp_list.confirm_button)

    add_cp.dropdown_click_input_click(add_cp.lke_cp_type_select, "Короб")
    add_cp.backspace_len_and_input(add_cp.cp_weight_input, base.random_value_int_str(10, 20000))
    add_cp.backspace_len_and_input(add_cp.cp_value_input, base.random_value_float_str(0.1, 35.0))
    add_cp.backspace_len_and_input(add_cp.cp_cost_input, base.random_value_int_str(100, 1000000))
    add_cp.dropdown_click_input_click(add_cp.lke_cp_status_select, "Новое")
