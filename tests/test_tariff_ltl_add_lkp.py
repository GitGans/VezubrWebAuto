...
def test_ltl_tariff_add_lkp(domain):
    ...
    add_tariff.input_in_field(add_tariff.kg_price_input, base.random_value_int_str(50, 200))
    add_tariff.input_in_field(add_tariff.temp_coeff_input, base.random_value_float_str(1.0, 5.0))
    add_tariff.input_in_field(add_tariff.delivery_time_input, base.random_value_int_str(5, 50))
