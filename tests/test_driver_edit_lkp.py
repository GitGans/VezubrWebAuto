...
def test_own_driver1_edit_lkp(domain):
    ...
    add_driver.backspace_and_input(add_driver.passport_id_input, base.random_value_int_str(1000000000, 9999999999))
    add_driver.backspace_and_input(add_driver.passport_by_input, "Верховный водилокомандующий")
    add_driver.backspace_and_input(add_driver.passport_code_input, base.random_value_int_str(100000, 999999))
    ...
    add_driver.backspace_and_input(add_driver.license_id_input, base.random_value_int_str(1000000000, 9999999999))
